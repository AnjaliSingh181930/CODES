...
class PGStudent : public Student{ //PGStudent inherit student class in public mode
    //properties or attributes
    public:
        int stipend;

        PGStudent(string name, int age, int rollNo, int stipend) : Student( name, age, rollNo){ //calling base contructor
            this -> stipend = stipend;
            cout<<"PGStudent constructor is called"<<endl;
        }
        ...
        ~PGStudent(){
                cout<<"PGStudent Destructor is called"<<endl;
        }                   
...
int main()
{
    PGStudent PG1("Anjali", 24, 1, 10000); //when object for student class is created ,constructor for base class is called then construtor for child class is called
